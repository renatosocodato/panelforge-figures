...
**Status:** ✅ **PACK COMPLETE** — all 4 waves merged (PRs #44–#47); pack-closeout PR #48 lands the rollup CHANGELOG and tag `v1.5.0-beta-cdc42_factorial_companion`. Catalog 423 → 448 (+25); 5 modalities touched.
