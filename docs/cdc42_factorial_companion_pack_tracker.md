...
|---|---|---|---|---|---|
| w1 | Universal robustness primitives + provenance (+5 in `meta_and_diagnostic`): Bayes-factor arrow plot, panel provenance ledger, cross-contrast correlation, multiverse classification, multiverse spec curve, proxy-alignment forest. Pioneers 2 new `core/` shims (`bayes_factor_utility`, `multiverse_specification_utility`). | **gap-analysis** | `beta-cdc42-companion-w1` | — | Wave 1 gap analysis in review (this doc + CHANGELOG pointer) |
