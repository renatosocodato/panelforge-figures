...
**Version label:** `[1.4.0-beta-disc1_manuscript_companion]` (sub-tags `-w1` … `-w4`)
...
**Anchor manuscript:** `/Users/renatosocodato/actin-mt_biophysics/manuscript/2026_disc1_microglial_cytoskeletal_confinement` — DISC1-linked microglial cytoskeletal confinement (in-vivo intravital + fixed-cell Airyscan + forward simulation).
...
| w3 | Cytoskeleton geometry + statistics (+9): F2D angle rose, F2E Cleveland, F3B censoring waterfall, F4C confinement gauge, FS2C-D Kinhom, FS2E edge-gradient, FS2F cortex composite, FS4E-F mesh-density, FS5B z-span vs width. | **gap-analysis** | `beta-disc1-companion-w3` | — | Wave 3 gap analysis in review |
...
| `CHANGELOG.md` | edit | "In planning" pointer rolled to disc1_manuscript_companion |
| `docs/disc1_manuscript_companion_pack_tracker.md` | **NEW** | This file |
...
2. CHANGELOG roll-up `[1.4.0-beta-disc1_manuscript_companion]` (full pack release notes summing 4 waves).
3. Tag `v1.4.0-beta-disc1_manuscript_companion`, push, GitHub release with per-wave delta table.
