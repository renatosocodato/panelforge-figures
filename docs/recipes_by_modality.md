...
**v1.4.0-beta-disc1_manuscript_companion — Wave 2 landed: 405 recipes** (cumulative across W1+W2: meta_and_diagnostic +6, actin_microtubule_morphometry +5, biophysics_scaling +1, intravital_imaging +1). Pack total: 13/31 recipes; 2/4 waves. See `docs/disc1_manuscript_companion_pack_tracker.md`.
...
## v1.4.0-beta-disc1_manuscript_companion — Wave 2 (cell territory + multiscale, +7)

Second wave of the disc1_manuscript_companion beta expansion pack.
