...
1. **DISC1 Figure 3 renders cleanly.** `figures compose tests/fixtures/figure_specs/example_figure_3.yaml` produces a single-page PDF with all six panels visible, panel labels A–F drawn, no matplotlib warnings, ≤ 5 s wall-clock.
